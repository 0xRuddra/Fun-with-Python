...
dll=b"C:\Users\MN\Desktop\Rough Practice\Python\Python-201\Remote-DLL-Injection\hello_world.dll"
#this is the location of our dll file (compiled from hello.c)
#now we are going to inject this file with a process .
#lets open a notepad and take its process id from task manager

pid=2160
#this is the pid of the notepad process as i am injecting with this process
